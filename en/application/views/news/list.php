        ...
        <div class="container">
            <div class="row">
                ...
                <?php foreach($newsResults as $newsResult) : ?>
                    ...
                    <div class="col-sm-6 col-md-4" style="height: 650px;">
...
<!--                                <p>--><?php //echo mb_substr($newsResult->description, 0, 250);?><!--</p>-->
                                ...
                                <a href="<?php echo base_url('index.php/news/single')?>?id=<?php echo $newsResult->id?>"><i class="fa fa-long-arrow-right"></i> <span>Read More</span></a>
                            </div>
                        </div>
                    </div>
