        ...
        <div class="row-fluid sortable">
            <div class="box span12">
                ...
                <div class="box-content">
                    <a href="<?php echo base_url('index.php/admin/newsBg/insert')?>" class="btn btn-large btn-success pull-right">Create News</a>
                        ...
                        <?php foreach ($blogResults as $blogResult) : ?>
                            <tr>
                                ...
                                <td class="center">
                                    ...
                                    <a class="btn btn-info" href="<?php echo base_url('index.php/admin/newsBg/edit')?>?id=<?php echo $blogResult->id; ?>">
                                        <i class="halflings-icon white edit"></i>
                                    </a>
                                    <a class="btn btn-danger"
                                       href="<?php echo base_url('index.php/admin/newsBg/delete')?>?id=<?php echo $blogResult->id; ?>">
